        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                ...
                <ul class="side-menu metismenu">
                    <li>
                        <a class="active" href="./"><i class="sidebar-item-icon fa fa-dashboard"></i>
                    ...
                    <li>
                        <a href="daftar_kamar.php"><i class="sidebar-item-icon fa fa-th-list"></i>
                            <span class="nav-label">Daftar Kamar</span>
                        </a>
                    </li>
                    <li>
                        <a href="daftar_harga.php"><i class="sidebar-item-icon fa fa-dollar"></i>
                    ...
                    <li>
                        <a href="laporan_piutang.php"><i class="sidebar-item-icon fa fa-credit-card-alt"></i>
